...
describe('color-converter util', () => {
  describe('convertFromHsl', () => {
    test('should return valid RGB and HEX', () => {
    ...
    test('should correctly convert a red color', () => {
    ...
    test('should correctly convert a purple color', () => {
    ...
    test('should correctly convert a green color', () => {
    ...
    test('should correctly convert a yellow-green color', () => {
    ...
    test('should correctly convert an orange color', () => {
  ...
  describe('convertFromRgb', () => {
    test('should return valid HSL and HEX', () => {
    ...
    test('should handle a green-based color correctly', () => {
    ...
    test('should handle a blue-based color correctly', () => {
    ...
    test('should correctly handle color with RGB of the same values', () => {
  ...
  test('convertFromHex should return valid HSL and RGB', () => {
  ...
  test('convertFromHex should return valid HSL and RGB with 3-character hex value', () => {
