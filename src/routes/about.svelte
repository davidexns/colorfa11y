...
<Section header="About Colorfa11y">
	...
	<p>
		I wanted a tool that enabled me to easily translate between color spaces and reactively
		calculate contrast ratio. There are a number of existing tools that perform the individual tasks
		very well in one way or another, but I wanted to create something that worked well for my
		personal workflow.
	</p>
	...
	<p>
		...
		<a href="https://www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodef">
			WCAG documentation
		</a>. The entirety of the source code is available on
...
<Section header="Resources & Inspiration">
	<ul>
		...
		<li><a href="https://convertingcolors.com/">Converting Colors</a></li>
		<li>
